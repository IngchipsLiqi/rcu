...
l2cap_send_echo_request = 0x0000cd0d;
l2cap_unregister_service = 0x0000cdcd;
le_device_db_add = 0x0000ce25;
le_device_db_find = 0x0000cefd;
le_device_db_from_key = 0x0000cf29;
le_device_db_iter_cur = 0x0000cf31;
le_device_db_iter_cur_key = 0x0000cf35;
le_device_db_iter_init = 0x0000cf39;
le_device_db_iter_next = 0x0000cf41;
le_device_db_remove_key = 0x0000cf67;
ll_aes_encrypt = 0x0000cf95;
ll_config = 0x0000d011;
ll_free = 0x0000d047;
ll_get_heap_free_size = 0x0000d051;
ll_hint_on_ce_len = 0x0000d065;
ll_legacy_adv_set_interval = 0x0000d09d;
ll_malloc = 0x0000d0ad;
ll_query_timing_info = 0x0000d1e5;
ll_register_hci_acl_previewer = 0x0000d231;
ll_scan_set_fixed_channel = 0x0000d295;
ll_set_adv_access_address = 0x0000d4ad;
ll_set_adv_coded_scheme = 0x0000d4b9;
ll_set_conn_acl_report_latency = 0x0000d4e9;
ll_set_conn_coded_scheme = 0x0000d519;
ll_set_conn_latency = 0x0000d545;
ll_set_conn_tx_power = 0x0000d575;
ll_set_def_antenna = 0x0000d5bd;
ll_set_initiating_coded_scheme = 0x0000d5d9;
ll_set_max_conn_number = 0x0000d5e5;
nibble_for_char = 0x0001e66d;
platform_32k_rc_auto_tune = 0x0001e719;
platform_32k_rc_tune = 0x0001e795;
platform_calibrate_32k = 0x0001e7a9;
platform_config = 0x0001e7ad;
platform_delete_timer = 0x0001e8d1;
platform_enable_irq = 0x0001e8d9;
platform_get_current_task = 0x0001e911;
platform_get_gen_os_driver = 0x0001e935;
platform_get_heap_status = 0x0001e93d;
platform_get_task_handle = 0x0001e955;
platform_get_timer_counter = 0x0001e975;
platform_get_us_time = 0x0001e979;
platform_get_version = 0x0001e97d;
platform_hrng = 0x0001e985;
platform_install_isr_stack = 0x0001e98d;
platform_install_task_stack = 0x0001e999;
platform_patch_rf_init_data = 0x0001e9d1;
platform_printf = 0x0001e9dd;
platform_raise_assertion = 0x0001e9f1;
platform_rand = 0x0001ea05;
platform_read_info = 0x0001ea09;
platform_read_persistent_reg = 0x0001ea39;
platform_reset = 0x0001ea49;
platform_set_abs_timer = 0x0001ea6d;
platform_set_evt_callback = 0x0001ea71;
platform_set_evt_callback_table = 0x0001ea85;
platform_set_irq_callback = 0x0001ea91;
platform_set_irq_callback_table = 0x0001eaad;
platform_set_rf_clk_source = 0x0001eab9;
platform_set_rf_init_data = 0x0001eac5;
platform_set_rf_power_mapping = 0x0001ead1;
platform_set_timer = 0x0001eadd;
platform_shutdown = 0x0001eae1;
platform_switch_app = 0x0001eae5;
platform_trace_raw = 0x0001eb11;
platform_write_persistent_reg = 0x0001eb29;
printf_hexdump = 0x0001ecdd;
pvPortMalloc = 0x0001f7d1;
pvTaskIncrementMutexHeldCount = 0x0001f8b9;
pvTimerGetTimerID = 0x0001f8d1;
pxPortInitialiseStack = 0x0001f8fd;
reverse_128 = 0x0001fadd;
reverse_24 = 0x0001fae3;
reverse_256 = 0x0001fae9;
reverse_48 = 0x0001faef;
reverse_56 = 0x0001faf5;
reverse_64 = 0x0001fafb;
reverse_bd_addr = 0x0001fb01;
reverse_bytes = 0x0001fb07;
sm_add_event_handler = 0x0001fdc5;
sm_address_resolution_lookup = 0x0001ff1d;
sm_authenticated = 0x00020299;
sm_authorization_decline = 0x000202a7;
sm_authorization_grant = 0x000202c7;
sm_authorization_state = 0x000202e7;
sm_bonding_decline = 0x00020301;
sm_config = 0x0002075d;
sm_config_conn = 0x00020775;
sm_encryption_key_size = 0x0002092b;
sm_just_works_confirm = 0x00020eb1;
sm_le_device_key = 0x000211fd;
sm_passkey_input = 0x00021293;
sm_private_random_address_generation_get = 0x0002164d;
sm_private_random_address_generation_get_mode = 0x00021655;
sm_private_random_address_generation_set_mode = 0x00021661;
sm_private_random_address_generation_set_update_period = 0x00021689;
sm_register_external_ltk_callback = 0x000217c5;
sm_register_oob_data_callback = 0x000217d1;
sm_request_pairing = 0x000217dd;
sm_send_security_request = 0x000222b3;
sm_set_accepted_stk_generation_methods = 0x000222d9;
sm_set_authentication_requirements = 0x000222e5;
sm_set_encryption_key_size_range = 0x000222f1;
sscanf_bd_addr = 0x0002264d;
sysSetPublicDeviceAddr = 0x00022a01;
uuid128_to_str = 0x00023175;
uuid_add_bluetooth_prefix = 0x000231cd;
uuid_has_bluetooth_prefix = 0x000231ed;
uxListRemove = 0x00023209;
uxQueueMessagesWaiting = 0x00023231;
uxQueueMessagesWaitingFromISR = 0x00023259;
uxQueueSpacesAvailable = 0x00023275;
uxTaskGetStackHighWaterMark = 0x000232a1;
uxTaskPriorityGet = 0x000232c1;
uxTaskPriorityGetFromISR = 0x000232dd;
vListInitialise = 0x00023397;
vListInitialiseItem = 0x000233ad;
vListInsert = 0x000233b3;
vListInsertEnd = 0x000233e3;
vPortEndScheduler = 0x000233fd;
vPortEnterCritical = 0x00023429;
vPortExitCritical = 0x0002346d;
vPortFree = 0x000234a1;
vPortSuppressTicksAndSleep = 0x00023535;
vPortValidateInterruptPriority = 0x0002365d;
vQueueDelete = 0x000236b9;
vQueueWaitForMessageRestricted = 0x000236e5;
vTaskDelay = 0x0002372d;
vTaskInternalSetTimeOutState = 0x00023779;
vTaskMissedYield = 0x00023789;
vTaskPlaceOnEventList = 0x00023795;
vTaskPlaceOnEventListRestricted = 0x000237cd;
vTaskPriorityDisinheritAfterTimeout = 0x0002380d;
vTaskPrioritySet = 0x000238b9;
vTaskResume = 0x00023981;
vTaskStartScheduler = 0x00023a05;
vTaskStepTick = 0x00023a95;
vTaskSuspend = 0x00023ac5;
vTaskSuspendAll = 0x00023b81;
vTaskSwitchContext = 0x00023b91;
xPortStartScheduler = 0x00023c39;
xQueueAddToSet = 0x00023d01;
xQueueCreateCountingSemaphore = 0x00023d25;
xQueueCreateCountingSemaphoreStatic = 0x00023d61;
xQueueCreateMutex = 0x00023da5;
xQueueCreateMutexStatic = 0x00023dbb;
xQueueCreateSet = 0x00023dd5;
xQueueGenericCreate = 0x00023ddd;
xQueueGenericCreateStatic = 0x00023e29;
xQueueGenericReset = 0x00023e91;
xQueueGenericSend = 0x00023f1d;
xQueueGenericSendFromISR = 0x00024089;
xQueueGiveFromISR = 0x00024149;
xQueueGiveMutexRecursive = 0x000241ed;
xQueueIsQueueEmptyFromISR = 0x0002422d;
xQueueIsQueueFullFromISR = 0x00024251;
xQueuePeek = 0x00024279;
xQueuePeekFromISR = 0x000243a1;
xQueueReceive = 0x0002440d;
xQueueReceiveFromISR = 0x00024539;
xQueueRemoveFromSet = 0x000245cd;
xQueueSelectFromSet = 0x000245ef;
xQueueSelectFromSetFromISR = 0x00024601;
xQueueSemaphoreTake = 0x00024615;
xQueueTakeMutexRecursive = 0x00024781;
xTaskCheckForTimeOut = 0x000247c5;
xTaskCreate = 0x00024835;
xTaskCreateStatic = 0x00024891;
xTaskGetCurrentTaskHandle = 0x00024901;
xTaskGetSchedulerState = 0x0002490d;
xTaskGetTickCount = 0x00024929;
xTaskGetTickCountFromISR = 0x00024935;
xTaskIncrementTick = 0x00024945;
xTaskPriorityDisinherit = 0x00024a11;
xTaskPriorityInherit = 0x00024aa5;
xTaskRemoveFromEventList = 0x00024b39;
xTaskResumeAll = 0x00024bb9;
xTaskResumeFromISR = 0x00024c81;
xTimerCreate = 0x00024d0d;
xTimerCreateStatic = 0x00024d41;
xTimerCreateTimerTask = 0x00024d79;
xTimerGenericCommand = 0x00024de5;
xTimerGetExpiryTime = 0x00024e55;
xTimerGetTimerDaemonTaskHandle = 0x00024e75;
